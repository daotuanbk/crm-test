...
export interface Service<TAggregate extends Aggregate, TQuery extends FindQuery, TRepository> {
  ...
  patch?: (id: string, data: PatchPayload, params: RequestParams<TRepository>) => Promise<{}>;
}

export type PatchFunc<TRepository> = (id: string, data: PatchPayload, params: RequestParams<TRepository>) => Promise<{}>;
