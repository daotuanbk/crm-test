export const overrideConfig = {
  ...
  web: {
    cors: {
      whitelistUrls: [
        'http://localhost:3001',
        'http://localhost:3000',
        'https://lmsmanagerdev.techkids.io',
        'https://lmsmanager.techkids.io',
        'https://manager.techkids.edu.vn',
        'https://0b5a2b3e.ngrok.io',
        'http://localhost:8887',
        'http://localhost:7785',
      ],
    },
  ...
  database: {
    connectionString: 'mongodb://localhost:27017/techkids-edu-crm',
    testConnectionString: 'mongodb://localhost:27017/techkids-edu-crm-test',
  },
  logger: {
    streams: [{
      level: 'debug',
